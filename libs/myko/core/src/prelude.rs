...
pub use crate::{
    ...
    core::{
        ...
        graph::{
            ...
            GraphClientExactQueries, GraphClientMutations, GraphClientNeighbors,
            GraphClientQueries, GraphClientSourcesTo, GraphClientSourcesToMany,
            GraphClientTargetsFrom, GraphClientTargetsFromMany, GraphDiagnostics, GraphEdge,
            GraphIndex, GraphReadiness, GraphSchemaCatalog, InCategory, IndexValue,
