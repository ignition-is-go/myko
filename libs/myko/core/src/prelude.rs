...
pub use crate::{
    ...
    core::{
        ...
        graph::{
            ...
            GraphClientQueries, GraphDiagnostics, GraphEdge, GraphIndex, GraphReadiness,
            GraphSchemaCatalog, InCategory, IndexValue, ItemCategoryRegistration, NoEdgeValidator,
            NoScope, OneOfEndpoint, PairPolicy, PairProjectionPolicy, QualifiedAddress,
            QualifiedEndpoint, SelfLoopPolicy, TraversalBuilder, TraversalResult, TypedEdgeEnds,
            Undirected,
        },
        item::{
