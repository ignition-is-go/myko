...
export const getEvents: Map<string, (isoDateTime: string) => Observable<EventContainer[]>> = new Map()
...
export const constructorRegistry: Map<string, MItemConstructor<MItem>> = new Map()
