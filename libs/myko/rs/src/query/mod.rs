...
// ─────────────────────────────────────────────────────────────────────────────
// Query Registration (inventory-based)
// ─────────────────────────────────────────────────────────────────────────────

use crate::parsers::query::MykoQueryParser;
...
) -> Result<cell::FilteredCellMap, String>;
...
use crate::parsers::query::CapturedQueryParser;
    ...
    Q::Item: Eventable + WithId + DeserializeOwned + Clone + std::fmt::Debug + Send + Sync + 'static,
{
    fn create_registration() -> RegisterQueryData {
        ...
        RegisterQueryData {
            ...
            parser,
            cell_factory: |any_query: Arc<dyn AnyQuery>, registry: Arc<StoreRegistry>, host_id: Uuid| -> Result<cell::FilteredCellMap, String> {
